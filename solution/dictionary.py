...
dictionary = dictionary_open()    # 사전에서 단어 정보 가져오기
  ...
  try :
    ...
    match menu :
      ...
      case "6" : # 통계
        ...
        print(f"단어의 문자 수가 가장 많은 단어 : {longest_word}")
        sorted_words = sorted(dictionary.keys(), key=len, reverse=True)
        print(f"3.단어 글자 수 내림차순 출력 (단어만) : ")
